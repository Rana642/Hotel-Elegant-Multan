...
export const LP_VARIANTS: Record<LpVariantKey, LpVariant> = {
  ...
  business: {
    ...
    heroAlt: 'King Room business room at Hotel Elegant Executive Suites Multan',
    featured: 'executive-king',
    metaTitle: 'Business Hotel in Multan Near the Airport | Hotel Elegant',
    metaDescription:
      'Business hotel in Multan ~7 km from the airport. Soundproof King Room with work desk & fast WiFi. 24/7 reception, best direct rate. Book on WhatsApp.',
  },
  premium: {
    key: 'premium',
