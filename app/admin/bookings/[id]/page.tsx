        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-4 text-sm font-montserrat">
              {[
                ...
                ...(Number(booking.tax_percent || 0) > 0
                  ? [{ label: `Includes GST + City Tax @ ${Number(booking.tax_percent)}%`, value: formatCurrency(Number(booking.tax_amount || 0)) }]
                  : []),
          ...
          <div className="print-only" style={{ marginTop: '24px', paddingTop: '16px', borderTop: '1px solid #ddd', fontSize: '10pt', color: '#333' }}>
            <p style={{ margin: '0 0 6px' }}>
              ...
              {Number(booking.tax_percent || 0) > 0
                ? ` (total ${formatCurrency(Number(booking.grand_total))} — includes ${Number(booking.tax_percent)}% GST + City Tax).`
                : '.'}
            </p>
            <p style={{ margin: '0 0 6px' }}>
