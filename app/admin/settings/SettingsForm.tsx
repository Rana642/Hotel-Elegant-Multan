...
const fields = [
  ...
  { key: 'hotel_tax_percent', label: 'GST (%)', type: 'number', hint: 'Punjab PRA hotel GST — 16% as of Sept 2026. Already included in every room rate; not added at checkout.' },
  { key: 'city_tax_percent', label: 'City Tax (%)', type: 'number', hint: 'Multan district hotel city tax — 10% as of Sept 2026. Already included in every room rate; not added at checkout.' },
